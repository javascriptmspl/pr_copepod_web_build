...
console.log(LoginUser,"dataloginusercheck")
          ...
          <Row>
            ...
            <Col lg="8">
              ...
              <div className="sign-user_card">
                ...
                <Link to="/settingPage" onClick={handleLinkClick}>                
                <h5 className="mb-3 pb-3 mt-4 a-border">Settings</h5>
                </Link>
                <Row>
                  <div className="col-12 setting"  onClick={handleLogout}>
