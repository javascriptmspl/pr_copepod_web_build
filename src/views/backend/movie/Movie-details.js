    ...
    sources: [
      {
        ...
        // src:`${BASE_URL}assets/videos/${moviesContent?.video?.path}`,
        type: "video/mp4",
      },
    ],
    // qualityLevels: [
    //   { label: 'Low', src: 'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4', type: 'video/mp4' },
    //   { label: 'Medium', src: 'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4', type: 'video/mp4' },
    //   { label: 'High', src: 'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4', type: 'video/mp4' }
    // ],
    controlBar: {
      skipButtons: {
        forward: 10,
                ...
                <div className="row">
                  <div className="col-md-9 col-12  mb-auto">
                    ...
                    <ul className="list-inline p-0 m-0 share-icons music-play-lists mb-1">
                      <li className="share">
                        ...
                        <div className="share-box">
                          <div className="d-flex align-items-center">
                            ...
                            <a onClick={copyURL} className="share-ico">
                      ...
                      <li>
                        <span
                          onClick={() => handleAddClick("Liked Successfully !")}
                        >
                      ...
                      <li>
                        <span
                          onClick={() => handleAddClick("Added Successfully !")}
                        >
                  ...
                  <div className="trailor-video col-md-3 col-12 mt-lg-0 mt-4 mb-md-0 mb-1 text-lg-right">
                    ...
                    >
                      <img
                        ...
                        height="1080"
                        src={banner}
                        // src={`${BASE_URL }assets/images/${items?.thumbnail_image}`}
              ...
              <li className=" slide-item iq-ltr-direction col-xl-3 col-lg-4 col-md-4 col-6">
                <div className="cast-images position-relative row mx-0">
                  ...
                  >
                    ...
                    <div
                      className="video-time  align-items-center my-2"
